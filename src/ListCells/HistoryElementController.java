...
/**
 * Created by gustav on 2017-03-10.
 */
public class HistoryElementController extends ListCell<ShoppingItem>{
    @FXML
    Label productName;
    ...
    FXMLLoader mLLoader;
    public HistoryElementController(){
        if (mLLoader == null) {
            mLLoader = new FXMLLoader(getClass().getResource("/ListCells/history_element.fxml"));
